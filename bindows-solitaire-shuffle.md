...
For this task, there needs to be a way to efficiently shuffle cards given a series of swaps, *k*, for indices *i<sub>k</sub>*, *j<sub>k</sub>*. 

### Outcome
Write a C function that swaps two bits  *i<sub></sub>*, *j<sub></sub>* for a 64-bit number *x*.
